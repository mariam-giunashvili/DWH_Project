...
## Project Overview
This project was developed for EPAM Systems' Data Analytics Engineering program, during specialization stage and focuses on integrating data from two OLTP (Online Transaction Processing) systems. The project follows a structured ETL (Extract, Transform, Load) process combining Inmon and Kimball methodologies for building the data warehouse. The implementation is done in PostgreSQL using PL/pgSQL, ensuring robust error handling, logging, and data management throughout the process.
